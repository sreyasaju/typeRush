...
"color:rgb(10, 24, 25);")
        ...
        self.setting_title.setGeometry(QRect(20, 70, 371, 21))
        font1 = QFont()
...
"")
        ...
        self.settings_instruction.setGeometry(QRect(20, 110, 381, 21))
        self.settings_instruction.setFont(font2)
        self.settings_instruction.setStyleSheet(u"color: rgb(0, 145, 134)")
        self.settings_instruction.setAlignment(Qt.AlignmentFlag.AlignCenter)
