...
class Ui_signupDialog(object):
    def setupUi(self, signupDialog):
        ...
        signupDialog.resize(406, 330)
        signupDialog.setStyleSheet(u"background-color: #e2fbff;\n"
"border-radius: 30px")
        self.groupBox = QGroupBox(signupDialog)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(0, 0, 391, 311))
...
"border-color: rgb(0, 207, 230);\n"
"padding: 12px;")
        self.buttonBox_2 = QDialogButtonBox(self.groupBox)
        self.buttonBox_2.setObjectName(u"buttonBox_2")
        self.buttonBox_2.setGeometry(QRect(10, 240, 361, 61))
        font1 = QFont()
        font1.setFamilies([u"Baloo Chettan 2"])
        font1.setPointSize(18)
        font1.setWeight(QFont.ExtraBold)
        self.buttonBox_2.setFont(font1)
        self.buttonBox_2.setStyleSheet(u"background-color: #00dacc;\n"
...
"")
    ...
    def retranslateUi(self, signupDialog):
        signupDialog.setWindowTitle(QCoreApplication.translate("signupDialog", u"Dialog", None))
        self.groupBox.setTitle(QCoreApplication.translate("signupDialog", u"GroupBox", None))
        self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("signupDialog", u"Password", None))
        self.lineEdit_3.setPlaceholderText(QCoreApplication.translate("signupDialog", u"Username", None))
        self.label.setText(QCoreApplication.translate("signupDialog", u"Sign Up", None))
    # retranslateUi
